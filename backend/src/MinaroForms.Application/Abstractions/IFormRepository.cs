...
public interface IFormRepository
{
    ...
    Task<Form?> GetByIdForStructureEditAsync(Guid id, CancellationToken cancellationToken = default);
    Task DeleteStructureAsync(Guid formId, CancellationToken cancellationToken = default);
