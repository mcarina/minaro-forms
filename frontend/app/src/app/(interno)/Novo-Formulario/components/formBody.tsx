  ...
  return (
    <main className="flex-1 p-6 overflow-y-auto">
      <div className="max-w-2xl mx-auto">
        {/* Form Header */}
        <div className="p-6 rounded-lg bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-violet-600/20 border border-purple-500/30 mb-6 flex flex-col gap-2">
          <input
            value={title}
